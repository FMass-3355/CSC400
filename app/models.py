...
class Exercise(db.Model):
    ...
    e_total_calories = db.Column(db.Integer)
    e_calories_per_hour = db.Column(db.Integer)
    e_duration_minutes = db.Column(db.Integer)
...
class Calorie(db.Model):
    ...
    c_calories_total = db.Column(db.Integer)
